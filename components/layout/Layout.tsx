...
const Layout: React.FC<LayoutProps> = ({ user, currentPage, setCurrentPage, onRefresh, children }) => {
    ...
    return (
        <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
            ...
            {loginSuccessMessage && (
                <div 
                    className="fixed top-5 left-1/2 -translate-x-1/2 z-50 flex items-center w-full max-w-xs p-4 space-x-4 rtl:space-x-reverse text-gray-500 bg-white rounded-lg shadow-lg dark:text-gray-400 dark:bg-gray-800" 
                    role="alert"
                >
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                <Header user={user} setSidebarOpen={setSidebarOpen} onRefresh={onRefresh} pageName={pageTitle} currentPage={currentPage} />
