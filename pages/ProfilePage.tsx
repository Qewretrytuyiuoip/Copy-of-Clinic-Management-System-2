...
import { LogoutIcon, PencilIcon, UserCircleIcon, XIcon, TrashIcon, PlusIcon, SearchIcon } from '../components/Icons';
...
const TreatmentsSettings: React.FC<{ refreshTrigger: number }> = ({ refreshTrigger }) => {
    ...
    return (
        <div className="mt-8">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-md max-w-4xl mx-auto min-h-[400px]">
                 <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
                     <div className="relative w-full max-w-sm">
                       ...
                       <input
                           ...
                           className="w-full pl-3 pr-10 py-2 bg-gray-100 dark:bg-gray-700 text-black dark:text-white border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                       />
                    </div>
    ...
    return (
        <>
            ...
            {currentUser && (currentUser.role === UserRole.Admin || currentUser.role === UserRole.SubManager) && (
                <TreatmentsSettings refreshTrigger={refreshTrigger} />
            )}
