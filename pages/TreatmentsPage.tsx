...
import { Treatment, User, UserRole } from '../types';
...
// ===================================================================
// Main TreatmentsPage Component
// ===================================================================
const TreatmentsPage: React.FC<{ refreshTrigger: number }> = ({ refreshTrigger }) => {
    const { user } = useAuth();
    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
                <h1 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-gray-100">العلاجات</h1>
